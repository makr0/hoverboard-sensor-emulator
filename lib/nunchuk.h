...
// Print debug information instead of a CSV stream to the serial2 port
...
static void nunchuk_init() {
...
#ifdef NUNCHUK_DEBUG
    Serial2.print("Ident: "); // 0xA4200000 for Nunchuck, 0xA4200101 for Classic, 0xA4200402 for Balance
    ...
    delay(100); // Wait for serial2 transfer, before loop()ing
#endif
...
#ifdef NUNCHUK_DEBUG
    Serial2.print("joy: ");
    Serial2.print(nunchuk_joystickX(), DEC);
    Serial2.print(", ");
    Serial2.print(nunchuk_joystickY(), DEC);

    Serial2.print("  acc:");
    Serial2.print(nunchuk_accelX(), DEC);
    Serial2.print(", ");
    Serial2.print(nunchuk_accelY(), DEC);
    Serial2.print(", ");
    Serial2.print(nunchuk_accelZ(), DEC);

    Serial2.print("  but:");
    Serial2.print(nunchuk_buttonZ(), DEC);
    Serial2.print(", ");
    Serial2.print(nunchuk_buttonC(), DEC);
    Serial2.print("\n");
#else
    Serial2.print(nunchuk_joystickX(), DEC);
    Serial2.print(",");
